...
class SP500Strategy:
    ...
    def _get_seasonality_score_from_data(self, row, seasonality_data):
        """
        Modified version that excludes seasonality scoring.
        Always returns a neutral score of 0.5.
        """
        return 0.5  # Neutral score, effectively disabling seasonality influence
...
def run_backtest(start_date, end_date, mode='backtest', max_signals=None, initial_capital=300, random_seed=42, weekly_selection=True): # No seasonality version
